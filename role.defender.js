...
var roleDefender = {
  ...
  body: [TOUGH, TOUGH, TOUGH, TOUGH, ATTACK, ATTACK, ATTACK, ATTACK, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE],
  build: function (creepMem) {
    var newName = 'Defender' + Memory.TaskMan.NameNum;
    Memory.TaskMan.NameNum++;
    return Game.spawns['BabyCakes'].spawnCreep(this.body, newName, { memory: { role: 'Defender', task: "movin" } });
  }
};
