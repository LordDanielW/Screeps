...
var modSpawn = {
  ...
  spawnCreeps: function () {
    if (Game.spawns["Spawn1"].spawning) {
      ...
      //Memory.TaskMan.spawn.queue != "none") {
      switch (Memory.TaskMan.spawn.queue[0]) {
        ...
        case "miner":
          ...
          Game.spawns["Spawn1"].spawnCreep(roleMiner.build, newName, {
            memory: { role: "miner", dest: new RoomPosition(13, 8, "W17N38") },
          });
          break;
      }
      ...
      var linker2 = _.filter(
        Game.creeps,
        (creep) => creep.memory.role == "linker2"
      );
      var miners3 = _.filter(
        Game.creeps,
        (creep) => creep.memory.role == "miner3"
      );
      var linker3 = _.filter(
        Game.creeps,
        (creep) => creep.memory.role == "linker3"
      );
